...
<head>
    ...
    <title>Pengajuan Kontrak Jasa - Dashboard | Konig Guard Bureau</title>
        ...
        <div class="mdk-header-layout__content page">
            ...
            <div class="container-fluid page__container">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3 mb-4 flex-wrap">
                    <div>
                        <h3 class="mb-1 font-weight-bold">Pengajuan Kontrak</h3>
                        <p class="text-muted mb-0">
                            Daftar Pengajuan Kontrak Masuk Dari Klien Order
                        </p>
                    </div>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control harga rupiah" inputmode="numeric"
                                                                oninput="this.value = this.value.replace(/[^0-9]/g, '')" value="" disabled>
                                                        </td>
                                            ...
                                            <div class="col-md-12 border rounded p-3">
                                                ...
                                                <div class="col-md-12 mt-3">
                                                    ...
                                                    <div class="d-inline-flex align-items-center shadow-sm"
                                                        style="
            background:#ecfdf3;
            color:#16a34a;
            border-radius:999px;
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text"
                                                    class="form-control border-0 bg-light"
                                                    value="Pengiriman Kontrak Kerja">
...
PT. Secure Guard Indonesia</textarea>
                                    ...
                                    <!-- ATTACHMENT -->
                                    <div class="mb-4">
                                        <label class="small text-muted font-weight-bold mb-3">
                                            Lampiran Kontrak (PDF)
                                        </label>

                                        <!-- UPLOAD AREA -->
                                        <div class="border-0 shadow-sm position-relative"
                                            style="
                        border-radius:18px;
                        background:linear-gradient(135deg,#f8fafc,#ffffff);
                        border:2px dashed #d6deff;
                        padding:35px 25px;
                    ">
    ...
    ">
                            ...
                            ">
                                                ...
                                                <div class="text-muted small mb-3">
                                                    Drag & drop file atau klik area ini
                                                </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between shadow-sm"
                                                style="
                            border-radius:14px;
                            padding:16px 18px;
                            background:#f8fafc;
                        ">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="material-icons mr-3 text-success">
                                                        email
                                                    </span>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="small text-muted">
                                                            Customer menerima email otomatis
                                                        </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <div class="small text-muted mb-2">
                                            Pastikan file kontrak sudah benar sebelum dikirim
                                        </div>

                                        <div class="d-flex">

                                            <!-- <button class="btn btn-light rounded-pill px-4 mr-2">
                                                Simpan Draft
                                            </button> -->

                                            <button id="btnSendContract" class="btn text-white rounded-pill px-4 shadow-sm"
                                                style="
                            background:linear-gradient(135deg,#6774df,#4e5de6);
                        ">
