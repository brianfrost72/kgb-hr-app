...
<head>
    ...
    <title>Manage Order - Dashboard | Konig Guard Bureau</title>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a href="detail_order.php" class="btn btn-sm btn-light mr-2" title="Lihat Pesan">
                                                ...
                                                <button class="btn btn-sm btn-success mr-2 btn-done-order"
                                                    data-toggle="modal"
                                                    data-target="#doneOrderModal" title="Pesanan Selesai?">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <a href="detail_order.php" class="btn btn-sm btn-light mr-2" title="Lihat Detail Pesan">
                                                    <span class="material-icons"
                                                        style="font-size:18px;">
                                                        visibility
                                                    </span>
        ...
        `
                    ...
                    <td>
                        ...
                        <div class="d-flex">
                            ...
                            <a href="detail_order.php" class="btn btn-sm btn-light mr-2 btn-view-message" title="Lihat Pesan">
                            ...
                            <button class="btn btn-sm btn-success mr-2 btn-done-order" 
    data-id="${item.id}" title="Pesanan Selesai">
