...
<body class="layout-fluid layout-sticky-subnav">
    ...
    <script>
        let data = [{
                ...
                alamat: "Jl. Pemuda No. 1, Jakarta Selatan, Indonesia"
            },
            {
                cabang: "Jakarta Timur",
                alamat: "Jl. Pemuda No. 2, Jakarta Timur, Indonesia"
            }
        ];
    ...
    `;
        ...
        function tambahData() {
            ...
            let cabang = document.getElementById("cabangTambah").value.trim();
            let alamat = document.getElementById("alamatTambah").value.trim();

            // VALIDASI
            if (!cabang || !alamat) {

                document.getElementById("validasiText").innerHTML =
                    "Cabang dan alamat wajib diisi";
        ...
        <strong>${cabang}</strong> berhasil ditambahkan
    `;
        ...
        function editData(index) {
            ...
            document.getElementById("cabangEdit").value = data[index].cabang;
            document.getElementById("alamatEdit").value = data[index].alamat;
        ...
        function updateData() {
            ...
            let cabang = document.getElementById("cabangEdit").value.trim();
            let alamat = document.getElementById("alamatEdit").value.trim();

            // VALIDASI
            if (!cabang || !alamat) {

                document.getElementById("validasiText").innerHTML =
                    "Cabang dan alamat edit wajib diisi";
            ...
            // TEXT
            document.getElementById("successText").innerHTML = `
        <strong>${cabang}</strong> berhasil di edit
    `;
