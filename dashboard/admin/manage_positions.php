...
<body class="layout-fluid layout-sticky-subnav">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="text" id="jabatanTambah" class="form-control mb-2" placeholder="Nama Jabatan">
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" id="jabatanEdit" class="form-control mb-2" placeholder="Nama Jabatan">
                </div>
                <div class="modal-footer">
    ...
    `;
        ...
        function tambahData() {
            ...
            let input = document.getElementById("jabatanTambah");
            ...
            if (exists) {
                ...
                document.getElementById("validasiText").innerHTML =
                    `Jabatan <strong>${nama}</strong> sudah tersedia`;
    ...
    `;
        ...
        function editData(index) {
            ...
            document.getElementById("jabatanEdit").value = data[index].nama;
        ...
        function updateData() {
            ...
            let input = document.getElementById("jabatanEdit");
            let nama = input.value.trim();
