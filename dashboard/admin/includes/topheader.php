  ...
  <div class="mdk-header__content">
    <div
      ...
      <div class="container-fluid p-0">
        ...
        <!-- Navbar Brand -->
        <a href="fluid-dashboard.html" class="my-navbar-brand">
          <img
            src="/my-dashboard/fixed-v2/dashboard/admin/assets/images/logos/logo.png"
            alt="Logo"
          ...
          <li class="nav-item dropdown">
            ...
            <div
              ...
              <div class="dropdown-item d-flex align-items-center py-2">
                ...
                <a href="javascript:void(0)" class="text-muted"><small>Tutup Notifikasi</small></a>
              </div>
              <div
        ...
        <ul
          ...
          <li class="nav-item dropdown">
            ...
            <div
              ...
              <a class="dropdown-item" href="fluid-edit-account.html"><i class="material-icons">account_circle</i> Edit Akun</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="fluid-login.html"><i class="material-icons">exit_to_app</i> Logout</a>
            </div>
          </li>
        </ul>
      </div>
