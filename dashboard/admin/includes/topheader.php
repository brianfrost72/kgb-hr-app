        ...
        <div class="mdk-header__content">
          ...
          >
            <div class="container-fluid p-0">
              ...
              <!-- Navbar Brand -->
              <a href="fluid-dashboard.html" class="navbar-brand">
                <svg
                  class="mr-2"
                        ...
                        <div class="dropdown-item d-flex">
                          <div class="mr-3">
                            <a href="#">
                              ...
                              >
                                <span
                                  class="avatar-title bg-purple rounded-circle"
              ...
              >
                <li class="nav-item dropdown">
                  ...
                  >
                    ...
                    <a class="dropdown-item active" href="fluid-dashboard.html"
                      ><i class="material-icons">dvr</i> Dashboard</a
                    >
                    <a class="dropdown-item" href="fluid-profile.html"
                      ><i class="material-icons">account_circle</i> My
                      profile</a
                    >
                    <a class="dropdown-item" href="fluid-edit-account.html"
                      ><i class="material-icons">edit</i> Edit account</a
                    >
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="fluid-login.html"
