...
<body class="layout-fluid layout-sticky-subnav">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="text" id="layananTambah" class="form-control mb-2" placeholder="Nama Layanan">
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" id="layananEdit" class="form-control mb-2" placeholder="Nama Layanan">
                </div>
                <div class="modal-footer">
    ...
    `;
        ...
        function tambahData() {
            let nama = document.getElementById("layananTambah").value;
            if (!nama) {
                alert("Harus diisi!");
                return;
            }
        ...
        function editData(index) {
            ...
            document.getElementById("layananEdit").value = data[index].nama;
        ...
        function updateData() {
            ...
            data[index].nama = document.getElementById("layananEdit").value;
