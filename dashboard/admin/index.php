...
<html lang="en" dir="ltr">
  <head>
    ...
    <script
      async
      src="https://www.googletagmanager.com/gtag/js?id=UA-133433427-1"
    ></script>
    <script>
  ...
  <body class="layout-fluid layout-sticky-subnav">
            ...
            <div class="col-lg-3 col-md-4 card-group-row__col">
              <div class="card card-group-row__card">
                <div class="p-2 d-flex flex-row align-items-center">
                  ...
                  <a href="#" class="text-dark">
                    <strong>Manage Berita/Artikel</strong>
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 card-group-row__col">
              <div class="card card-group-row__card">
                <div class="p-2 d-flex flex-row align-items-center">
                  ...
                  <a href="#" class="text-dark">
                    <strong>Manage Struktur Perusahaan</strong>
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 card-group-row__col">
              <div class="card card-group-row__card">
                <div class="p-2 d-flex flex-row align-items-center">
                  ...
                  <a href="#" class="text-dark">
                    <strong>Manage Layanan Kami</strong>
                  </a>
                </div>
              </div>
            </div>
              ...
              <div class="card">
                ...
                >
                  ...
                  <ul class="nav nav-pills" id="chartToggle">
                    <li class="nav-item">
                      <a class="nav-link active" data-type="daily" href="#"
                        >Harian</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" data-type="weekly" href="#"
                        >Mingguan</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" data-type="monthly" href="#"
                        >Bulanan</a
                      >
                    </li>
                  </ul>
              ...
              <div class="card">
                ...
                >
                  ...
                  <ul class="nav nav-pills" id="revenueToggle">
                    <li class="nav-item">
                      <a class="nav-link active" data-type="personal" href="#"
                        >Personal</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" data-type="company" href="#"
                        >Perusahaan</a
                      >
                    </li>
                    <li class="nav-item">
    ...
    <script>
      ...
      const revenueData = {
        personal: [
          ...
          { date: "2026-02-05", value: 350 },
          { date: "2026-03-12", value: 500 },
          { date: "2026-04-04", value: 300 },
          { date: "2026-05-20", value: 450 },
        ],
        company: [
          { date: "2026-01-15", value: 1000 },
          { date: "2026-02-10", value: 1200 },
          { date: "2026-03-22", value: 900 },
          { date: "2026-04-18", value: 1500 },
          { date: "2026-05-25", value: 1800 },
        ],
      };
    ...
    <script>
      ...
      const personnelData = [
        { dept: "Security", gender: "L", status: "tetap" },
        { dept: "Security", gender: "P", status: "kontrak" },
        { dept: "Bodyguard", gender: "L", status: "tetap" },
        { dept: "Driver", gender: "L", status: "kontrak" },
        { dept: "Pramubakti", gender: "P", status: "tetap" },
        { dept: "Cleaning", gender: "P", status: "kontrak" },
        { dept: "Pengacara", gender: "L", status: "tetap" },
        { dept: "Driver", gender: "L", status: "tetap" },
        { dept: "Security", gender: "L", status: "kontrak" },
        { dept: "Cleaning", gender: "P", status: "tetap" },
      ];
    ...
    <script>
      const clientData = [
        { type: "personal", status: "aktif" },
        { type: "personal", status: "nonaktif" },
        { type: "personal", status: "aktif" },
        { type: "company", status: "aktif" },
        { type: "company", status: "nonaktif" },
        { type: "company", status: "aktif" },
        { type: "company", status: "aktif" },
        { type: "personal", status: "aktif" },
      ];
